...
export const SKILL_MANIFEST = {
  ...
  'reading-matchingHeadings': {
    ...
    hookPromptHint:   'a paragraph where one heading option describes a specific detail (the distractor) and the correct heading captures the main idea of the whole paragraph',
    prerequisite:     'reading-tfng',
    accuracyGate:     75,
  },
